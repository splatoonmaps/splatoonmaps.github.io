        ...
        .append($('<div class="col-xs-12 col-md-6">')
          .append($('<div class="map">')
            ...
            .append($('<div class="graph-month">')
              ...
              .append('<div class="graph-name">June 2016</div>')
              .append(buildGraph(data[i].splatzones.jun2016,data[i].towercontrol.jun2016,data[i].rainmaker.jun2016,"s"))
              .append('<div class="graph-name">July 2016</div>')
              .append(buildGraph(data[i].splatzones.jul2016,data[i].towercontrol.jul2016,data[i].rainmaker.jul2016,"s"))
              .append('<div class="graph-name">August 2016</div>')
              .append(buildGraph(data[i].splatzones.aug2016,data[i].towercontrol.aug2016,data[i].rainmaker.aug2016,"s"))
              .append('<div class="graph-name">September 2016</div>')
              .append(buildGraph(data[i].splatzones.sep2016,data[i].towercontrol.sep2016,data[i].rainmaker.sep2016,"s"))
              .append('<div class="graph-name">October 2016</div>')
              .append(buildGraph(data[i].splatzones.oct2016,data[i].towercontrol.oct2016,data[i].rainmaker.oct2016,"s"))
              .append('<div class="graph-name">November 2016</div>')
              .append(buildGraph(data[i].splatzones.nov2016,data[i].towercontrol.nov2016,data[i].rainmaker.nov2016,"s"))
              .append('<div class="graph-name">December 2016</div>')
              .append(buildGraph(data[i].splatzones.dec2016,data[i].towercontrol.dec2016,data[i].rainmaker.dec2016,"s"))
            )
          )
      )
    };
